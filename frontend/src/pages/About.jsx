    ...
    <div>
      ...
      <div className='flex flex-col md:flex-row text-sm mb-20'>
        <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          ...
          <p className='text-gray-600'>Each product is carefully inspected to meet our high quality standards, ensuring reliable, well-crafted items every time.</p>
        </div>

        <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          <b>Convenience:</b>
          <p className='text-gray-600'>Our smooth, intuitive platform and quick checkout make shopping simple, fast, and effortlessly convenient.</p>
        </div>

        <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          <b>Exceptional Customer Service:</b>
          <p className='text-gray-600'>Our committed support team is always ready to guide you, ensuring every step of your shopping experience is smooth and satisfying.</p>
        </div>
      </div>

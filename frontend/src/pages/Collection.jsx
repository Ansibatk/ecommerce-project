...
const Collection = () => {
  ...
  const applyFilter = () => {
    ...
    console.log(
  products.filter(item => item.category === "Kids" && item.subCategory === "Winterwear")
);
    setFilterProducts(productsCopy)
  }

  const sortProduct = () => {
    // fpCopy means filterProductCopy
    ...
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className='flex-1'>
        <div className='flex justify-between text-base sm:text-2xl mb-4'>
          ...
          {/* Product Sort */}
          <select onChange={(e) => setSortType(e.target.value)} className='select border-2 border-gray-300 text-sm px-2'>

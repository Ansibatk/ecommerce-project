...
const Navbar = () => {
  ...
  return (
    <div className='navbar flex items-center justify-between py-5 font-medium'>
      <Link to={'/'}><img src={assets.logo} className=' logo w-36' alt="" /></Link>
      ...
      <div className='flex items-center gap-6'>
        ...
        <button
          onClick={toggleTheme}
          className="relative w-12 h-6 bg-gray-300 dark:bg-gray-700 rounded-full flex items-center transition-all duration-300 px-1"
        >
          <div
            className={`
      absolute w-5 h-5 rounded-full bg-white shadow-md flex items-center justify-center transition-all duration-300
